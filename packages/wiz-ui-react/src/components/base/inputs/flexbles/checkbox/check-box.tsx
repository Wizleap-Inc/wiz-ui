...
const FlexibleCheckboxNew = forwardRef<HTMLInputElement, Props>(
  (
    {
      className,
      style,
...
FlexibleCheckboxNew.displayName = ComponentName.CheckBoxNew;

export const FlexibleWizCheckBoxNew = FlexibleCheckboxNew;
